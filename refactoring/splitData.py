...
if __name__ == '__main__':
        ...
        X_test.to_csv(sys.argv[2]+"X_test.csv",index=False)
        y_test.to_csv(sys.argv[2]+"y_test.csv",index=False)
        X_val.to_csv(sys.argv[2]+"X_val.csv",index=False)
        y_val.to_csv(sys.argv[2]+"y_val.csv",index=False)
        X_train.to_csv(sys.argv[2]+"X_train.csv",index=False)
        y_train.to_csv(sys.argv[2]+"y_train.csv",index=False)
